...
Account_Retailer = pd.read_csv("C:\A\TradeUK\TradeUK Work\Changes\Report 1630 Descrepancies\C24PR.TRFCM.STRIP.DOWN1.ACCTS",
                               names=['ACCOUNT-NUMBER','Retailer','Status'],skiprows=[0])
Close = pd.read_csv("C:\A\TradeUK\TradeUK Work\Changes\Report 1630 Descrepancies\C24PR.TRFCM.STRIP.DOWN2.CLOSE",sep=',',delimiter=',',
                    index_col=False)
Open = pd.read_csv("C:\A\TradeUK\TradeUK Work\Changes\Report 1630 Descrepancies\C24PR.TRFCM.STRIP.DOWN2.OPEN",sep='\t')
Transactions = pd.read_csv("C:\A\TradeUK\TradeUK Work\Changes\Report 1630 Descrepancies\C24PR.TRFCM.STRIP.DOWN2.TRANS")
...
Final_Rec.to_csv("C:\A\TradeUK\TradeUK Work\Changes\Report 1630 Descrepancies\Final_Rec", index=False)
